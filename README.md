...
```javascript
import kernelSincosf from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-kernel-sincosf@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-base-special-kernel-sincosf/tags). For example,

```javascript
import kernelSincosf from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-kernel-sincosf@v0.1.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-kernel-sincosf@deno/mod.js';
```
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/math-base-special-kernel-sincosf.svg
[dependencies-url]: https://david-dm.org/stdlib-js/math-base-special-kernel-sincosf/main
...
[deno-url]: https://github.com/stdlib-js/math-base-special-kernel-sincosf/tree/deno
[deno-readme]: https://github.com/stdlib-js/math-base-special-kernel-sincosf/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/math-base-special-kernel-sincosf/tree/umd
[umd-readme]: https://github.com/stdlib-js/math-base-special-kernel-sincosf/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/math-base-special-kernel-sincosf/tree/esm
